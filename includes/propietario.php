        ...
        if ($email!="") {
            ...
            if ($result['suceed'] == 'true' && count($result['data']) > 0) {
                if ($result['data'][0]['email']!='') {
                    ...
                    if ($r=="") {
                        ...
                        $result['error']="No se puedo enviar el correo electrónico.
                            Póngase en contacto con Condominios Margarita";
                    }
                ...
                $result['error']="Correo electrónico no registrado. Si considera
                    que es un error, póngase en contacto con Condominios Margarita.";
            }
        } else {
            $result['suceed']=false;
            $result['error'] = "Debe introducir su correo electrónico principal.";
        ...
        if ($propieatarios['suceed'] && count($propieatarios['data'])>0) {
            ...
            if (file_exists($template)) {
                ...
                foreach ($propieatarios['data'] as $propietario) {
                    ...
                    $usuario = $e < 250 ? 'no_reply@condominiosmargarita.com.ve':'no_reply@condominiosmargarita.com.ve';
